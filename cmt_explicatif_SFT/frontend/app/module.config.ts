...
/* Ce code est obtenu automatiquement en faisant cette ligne de commande dans GeoNature backend:
   geonature update_module_configuration
   Cette commande met à jour la configuration du coeur de l'application. 
   A exécuter suite à un modification du fichier ``geonature_config.toml`` */
