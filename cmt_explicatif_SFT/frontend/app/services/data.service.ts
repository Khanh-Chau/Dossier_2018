...
export class DataService {
  ...
  */
  ...
  getMaille(id_base_site: number, params?:any) {
    ...
    return this._http.get<any>(`${AppConfig.API_ENDPOINT}/gn_monitoring/siteareas/${id_base_site}`, {params: myParams});
  }
...
*/
  ...
  getCommune(id_base_site:number, params:any) {
    ...
    return this._http.get<any>(`${AppConfig.API_ENDPOINT}/suivi_flore_territoire/info_zp/${id_base_site}`, {params: myParams});
  }
